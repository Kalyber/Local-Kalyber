...
<footer>
	<div class="footer__inner">
		<div class="footer__text">
			&copy; <?php echo date("Y"); ?> Kalyber • <a href="mailto:hello@kalyber.com">hello@kalyber.com</a> <span>•</span> <a href="/privacy">Privacy Policy</a>
		</div>
...
<div class="page-info" style="height:0px;">
	<input style="height:0px;border:none;padding:0;" id="categories" type="hidden" value="test" />
	<input style="height:0px;border:none;padding:0;" id="is404" tyoe="hidden" value="test" />
	<input style="height:0px;border:none;padding:0;" id="lastUpdated" type="hidden" value="test" />
	<input style="height:0px;border:none;padding:0;" id="pageId" type="hidden" value="test" />
	<input style="height:0px;border:none;padding:0;" id="pageName" type="hidden" value ="test" />
	<input style="height:0px;border:none;padding:0;" id="pageTemplate" type="hidden" value="test" />
	<input style="height:0px;border:none;padding:0;" id="tags" type="hidden" value="test" />
</div>

<script>
	$(document).ready(function () {
		$(".hero-header__wrap").click(function(){
			alert("ITWORKS");
  		});
	});
</script>
