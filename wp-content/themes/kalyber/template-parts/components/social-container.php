<div class="blog__social__container color__gold--bk">
    <div class="blog__social__wrap">
        ...
        <div class="social-icons__wrap">
            <div class="social-icons__wrap__inner">
                <!-- facebook -->
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 20 20"><title>Share on Facebook</title>
                ...
                <!-- twitter -->
                <a onclick="window.open('https://twitter.com/share?url=<?php echo get_permalink( $post->ID ); ?>&amp;text=<?php the_title();?> &amp;hashtags=kalyber', 'sharer', 'toolbar=0,status=0,width=620,height=280');" href="javascript: void(0)">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 20 20"><title>Share on Twitter</title>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 20 20"><title>Share on LinkedIn</title>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 20 20"><title>Share by email</title>
